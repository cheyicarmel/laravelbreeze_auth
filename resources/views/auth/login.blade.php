            ...
            <div class="card-body p-3 p-md-4 p-xl-5">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="row gy-3 overflow-hidden">
                        ...
                        <!-- <div class="col-12">
                            <div class="form-check">
                                ...
                                <label class="form-check-label text-secondary" for="iAgree">
                                    J'accepte <a href="#!" class="link-primary text-decoration-none" required> les termes et conditions</a>
                                </label>
                            </div>
                        </div> -->
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="d-grid">
                                <a href="/register" class="btn bsb-btn-xl btn-primary" type="submit">S'inscrire</a>
                            </div>
                        </div>
                    </div>  
                </form>
