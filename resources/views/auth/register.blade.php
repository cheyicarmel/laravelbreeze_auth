            ...
            <div class="col-12 col-md-9 col-lg-7 col-xl-6 col-xxl-5">
                ...
                <div class="card-body p-3 p-md-4 p-xl-5">
                    ...
                    <div class="col-12">
                        ...
                        <h3 class="fs-6 fw-normal text-secondary text-center m-0">Entrez vos informations pour pouvoir vous inscrire</h3>
                        </div>
                    </div>
                        ...
                        <div class="row gy-3 overflow-hidden">
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="name" id="name" placeholder="Nom complet" required autofocus>
                            ...
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                    <input type="password" class="form-control" name="password_confirmation" id="password_confirmation" value="" placeholder="Confirmer le mot de passe" required>
                            ...
                            <div class="col-12">
                                <div class="d-grid">
                                    <button class="btn bsb-btn-xl btn-outline-primary" type="submit">S'inscrire</button>
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="col-12">
                        ...
                        <p class="m-0 text-secondary text-center">Vous avez déjà un compte? <a href="/login" class="link-primary text-decoration-none">Connectez vous</a></p>
                    </div>
                    </div>
                    <div class="row">
                    <div class="col-12">
                        <p class="mt-5 mb-5">Ou inscrivez vous avec :</p>
